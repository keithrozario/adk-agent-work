...
data = {
    ...
    "adkAgentDefinition": {
        "toolSettings": {
            "toolDescription": "An Agent to manage my calendar"
        },
...
try:
    ...
    agent_endpoint_url = f"https://discoveryengine.googleapis.com/v1alpha/{agent_resource_url}"
    r = requests.delete(
...
r = requests.post(
    url=agent_registration_endpoint,
    data=json.dumps(data),
    headers=headers
)
